...
export const metadata: Metadata = {
  title: "Chat Warmup",
  description: "Practice better conversations with AI",
};
...
export default async function RootLayout({
  ...
  // Get the current hostname from request headers to use for base URL
    ...
    <Suspense fallback={<div>Loading...</div>}>
      <ConditionalClerkProvider>
        <html lang="en" suppressHydrationWarning>
          <head>
            <NextChatSDKBootstrap baseUrl={currentBaseUrl} />
          </head>
          <body
